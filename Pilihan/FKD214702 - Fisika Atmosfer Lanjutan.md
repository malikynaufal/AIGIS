...
Catalytic destruction by $HO_x$, $NO_x$, and $ClO_x$ species accelerates ozone loss. The steady-state ozone concentration is:
...
$$\frac{\partial u}{\partial t} = -(u \cdot \nabla) u + fv - \frac{\partial \Phi}{\partial x} + F_x$$

**Thermodynamic equation:**

$$\frac{\partial T}{\partial t} = -u \cdot \nabla T + \frac{\omega}{c_p}(\gamma_d - \gamma) + Q/c_p$$
