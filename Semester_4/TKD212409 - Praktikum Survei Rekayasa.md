...
$$
\text{Error Vertical} = \sqrt{(1")^2 + (1 \text{ ppm})^2 \times D}
$$
...
**Akurasi RTK:**
$$
\text{Horizontal Error} = \sqrt{(10 \text{ mm} + 1 \text{ ppm} \times D)^2}
$$

$$
\text{Vertical Error} = \sqrt{(15 \text{ mm} + 1.5 \text{ ppm} \times D)^2}
$$
