...
**Meaning:** Differentiation undoes integration. The rate of change of the accumulated area is the integrand itself.
...
$$\int 2x \cos(x^2)\, dx \quad \text{let } u = x^2, \, du = 2x\, dx$$
$$= \int \cos u\, du = \sin u + C = \sin(x^2) + C$$

**Example:**

$$\int \frac{x}{1+x^2}\, dx \quad \text{let } u = 1+x^2, \, du = 2x\, dx$$
$$= \frac{1}{2}\int \frac{du}{u} = \frac{1}{2}\ln|1+x^2| + C$$
...
$$\int \frac{5x+3}{(x+1)(x+2)}\, dx = \int\left(\frac{-2}{x+1} + \frac{7}{x+2}\right)dx = -2\ln|x+1| + 7\ln|x+2| + C$$
...
$$\int \frac{dx}{\sqrt{4-x^2}} \quad x = 2\sin\theta,\; dx = 2\cos\theta\, d\theta$$
$$= \int \frac{2\cos\theta}{2\cos\theta}\, d\theta = \theta + C = \arcsin\frac{x}{2} + C$$
...
- $\int \sec^2 x \tan^n x\, dx$: let $u = \tan x$
...
For functions of $y$: $A = \int_c^d |x_R(y) - x_L(y)|\, dy$

### 6.2 Volume of Solids of Revolution
...
**Shell method** (revolve about $y$-axis):
