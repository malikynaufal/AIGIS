...
$$\gamma_0 = \frac{a\,g_p\sin^2\varphi + b\,g_e\cos^2\varphi}{\sqrt{a^2\cos^2\varphi + b^2\sin^2\varphi}}$$
...
**Step 2: Drift correction at each station time:**
...
$$g_A = 978\,052.432 + 14.325 = 978\,066.757\;\text{mGal}$$
