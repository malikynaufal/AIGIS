...
- **Kurevatur Gaussian** $K = \kappa_1\kappa_2$ dan *mean curvature* $H = (\kappa_1+\kappa_2)/2$
- Hubungan dengan derajat flattening ellipsoid
...
- **Tensor metrik kedua** (second fundamental form):

$$II = L\,du^2 + 2M\,du\,dv + N\,dv^2$$

- **Kurevatur Gaussian** dari tensor metrik:
...
### 3. Garis Geodesik
Garis geodesik adalah garis terpendek antara dua titik pada permukaan. Persamaan diferensial garis geodesik pada permukaan:
