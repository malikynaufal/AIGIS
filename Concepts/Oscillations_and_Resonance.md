...
where $\omega_0 = \sqrt{k/m}$ (natural angular frequency).

### Energy
- Kinetic: $K = \frac{1}{2}mv^2 = \frac{1}{2}m\omega_0^2 A^2 \sin^2(\omega_0 t + \phi)$
- Potential: $U = \frac{1}{2}kx^2 = \frac{1}{2}m\omega_0^2 A^2 \cos^2(\omega_0 t + \phi)$
- Total: $E = \frac{1}{2}m\omega_0^2 A^2$ (constant)
...
### Equation of Motion (Driving Force)
...
$$\omega_{\text{res}} = \sqrt{\omega_0^2 - 2\gamma^2} \quad \text{(amplitude resonance)}$$

For small damping ($\gamma \ll \omega_0$): $\omega_{\text{res}} \approx \omega_0$

Maximum amplitude at resonance:
$$A_{\text{max}} = \frac{F_0}{2\gamma m\omega_0} = \frac{Q \cdot F_0}{m\omega_0^2}$$

### Power Absorption
$$P(\omega) = \frac{F_0^2}{2b}\frac{\gamma^2}{\gamma^2 + (\omega-\omega_0)^2} \quad \text{(Lorentzian, near resonance)}$$

Full width at half-maximum (FWHM): $\Delta\omega = 2\gamma = \omega_0/Q$
...
$$m_2\ddot{x}_2 = -k_2 x_2 + k_{12}(x_1 - x_2)$$

### Normal Modes
Solutions are superpositions of normal modes:
$$x_i(t) = A_i e^{i\omega_\alpha t + \phi_\alpha}$$

For $m_1 = m_2 = m$ and $k_1 = k_2 = k$:
