...
1. $eta = v/c = 3874/3	imes10^8 = 1.29 	imes 10^{-5}$
2. $\gamma = 1/\sqrt{1-eta^2} pprox 1 + 8.3	imes 10^{-11}$
3. Per day: $\Delta t = v^2/(2c^2) 	imes T = -7.2\,\mu	ext{s}$ (satellite clock runs *slower*)
...
- Mass squared: $p^\mu p_\mu = -m^2 c^2$
...
- $K = (\gamma - 1)mc^2 = (2.29 - 1) 	imes 0.511\,	ext{MeV} = 0.66\,	ext{MeV}$
- Classical: $K = rac{1}{2}mv^2$ would give $0.5	imes0.511	imes0.81 = 0.21\,	ext{MeV}$ (off by factor 3).
