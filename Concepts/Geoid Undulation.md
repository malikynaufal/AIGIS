...
$$V(r,\phi,\lambda) = \frac{GM}{r}\sum_{n=0}^{360}\sum_{m=0}^{n} \left(\frac{a}{r}\right)^n \left[C_{nm}\cos m\lambda + S_{nm}\sin m\lambda\right] P_{nm}(\cos\phi)$$

- Grid spacing: 2.5 arcminutes
...
3. $N = N_{00}(1-t)(1-u) + N_{01}(1-t)u + N_{10}t(1-u) + N_{11}tu$

where $t = (\phi - \phi_0)/\Delta\phi$ and $u = (\lambda - \lambda_0)/\Delta\lambda$.
...
$$\zeta(\phi,\lambda) = \frac{1}{4\pi\gamma_0}\iint_\sigma \Delta g(\phi',\lambda') \, S(\psi) \, d\sigma'$$
