...
$$\frac{a^3 \omega^2}{GM} = \frac{2f - f^2}{(1 - f)^2} \left(1 - \frac{3}{2}m\right), \quad m = \frac{\omega^2 a^3}{GM}$$

Solving iteratively for $f$ with $a$, $GM$, $\omega$ known yields GRS80's flattening.

**Normal gravity formula (Somigliana):**
$$g_0(\phi) = \frac{GM}{a b} \cdot \frac{1 + k\sin^2\phi}{\sqrt{1 - e^2\sin^2\phi}}$$

where:
$$k = \frac{b\,\omega^2\,a}{GM} - \frac{3}{2}J_2\left(\frac{a\,\omega^2\,a}{GM}\right)$$

## Comparison: GRS80 vs. WGS84
