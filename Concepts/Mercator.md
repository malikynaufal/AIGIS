...
$$
y = R \ln \left[ \tan \left( \frac{\pi}{4} + \frac{\phi}{2} \right) \right] = R \, \text{gd}^{-1}(\phi)
$$

where $\lambda_0$ is the **central meridian** (garis tengah), and $\text{gd}^{-1}$ is the inverse **Gudermannian function**:
$$
