...
- 1st order: $\frac{dy}{dx} = f(x,y)$
- 2nd order: $\frac{d^2y}{dx^2} + f\frac{dy}{dx} + g\,y = h$
...
### 2.2 First-Order Linear DEs

Form: $\frac{dy}{dx} + P(x)y = Q(x)$

**Integrating factor**: $\mu(x) = e^{\int P(x)\,dx}$

Multiply through: $\frac{d}{dx}[\mu y] = \mu Q$
...
Form: $M(x,y)\,dx + N(x,y)\,dy = 0$ is exact if $\frac{\partial M}{\partial y} = \frac{\partial N}{\partial x}$

**Method**: Find $F(x,y)$ such that $\frac{\partial F}{\partial x} = M$, $\frac{\partial F}{\partial y} = N$
...
### 3.2 Non-homogeneous: $ay'' + by' + cy = g(x)$
...
### 5.4 Solving IVPs with Laplace

**Example**: $y'' + 3y' + 2y = e^{-t}$, $y(0)=0$, $y'(0)=1$

Take Laplace: $(s^2+3s+2)Y - 1 = \frac{1}{s+1}$
...
### Problem 1
Solve $\frac{dy}{dx} = \frac{x}{y}$, $y(0) = 3$
...
**Solution**: Characteristic equation $r^2-5r+6=0$, roots $r=2,3$
$$y = C_1e^{2x} + C_2e^{3x}$$
$y(0)=1$: $C_1+C_2=1$
$y'(0)=2$: $2C_1+3C_2=2$
