---
code: FKD211502
name: Fisika Inti dan Partikel
SKS: 3
semester: 5
department: Fisika
tags: [physics, nuclear-physics, particle-physics, standard-model, quarks]
created: 2026-07-27
---

# FKD211502 — Fisika Inti dan Partikel

## Course Overview

Nuclear and particle physics explores the structure of matter at the smallest scales — from the atomic nucleus to fundamental particles (quarks, leptons) and the forces that govern them. This course covers nuclear reactions, radioactivity, and the Standard Model of particle physics.

**Contact Hours:** 3 SKS (2 hours lecture + 1 hour tutorial per week)
**Prerequisites:** Mekanika Kuantum, Fisika Dasar II
**Co-requisites:** None
...
### Unit 1: Nuclear Structure (Weeks 1–5)
- **Nuclear composition:** Z = protons, N = neutrons, A = Z+N
- **Nuclear size:** R = R₀A^{1/3}, with R₀ ≈ 1.2 fm
...
1. Explain nuclear structure using the liquid drop and shell models
2. Understand types of radioactive decay and calculate activity, half-life
3. Apply conservation laws to nuclear reactions (fission, fusion)
4. Identify fundamental particles and their roles in the Standard Model
5. Explain the significance of the Higgs boson and gauge bosons
6. Understand principles of radiation detection and applications in geophysics

---

## 📚 References

1. Krane, K.S. (1987). *Introductory Nuclear Physics*. Wiley. (The standard text)
2. Griffiths, D.J. (2008). *Introduction to Elementary Particles*, 2nd ed. Wiley.
3. Martin, B.R. & Shaw, G. (2019). *Nuclear and Particle Physics*, 3rd ed. Wiley.
4. Perkins, D.H. (2000). *Introduction to High Energy Physics*, 4th ed. Cambridge.
