...
- Konsep signifikansi statistik: tingkat $\alpha = 0.05$ dan nilai-$p$
- Kerangka konseptual dan diagram alir penelitian
...
- Regresi linear dan regresi spasial: $Y = \beta_0 + \beta_1 X_1 + \beta_2 X_2 + \varepsilon$
- Analisis autokorelasi spasial: Indeks Moran's $I$, Geary's $C$
- Geostatistik: kriging, semivariogram, dan interpolasi spasial
