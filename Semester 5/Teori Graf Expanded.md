...
- **Types**: Simple, multigraph, directed, weighted, bipartite, planar
...
- **Spanning trees**: Tree containing all vertices of $G$
- **Minimum spanning tree**: Kruskal's algorithm, Prim's algorithm
- **Cayley's formula**: $n^{n-2}$ spanning trees of $K_n$

### Unit 4: Eulerian and Hamiltonian Graphs
...
- **Four Color Theorem**: Planar graphs have $\\chi \\leq 4$
- **Edge coloring**: Vizing's theorem: $\\Delta \\leq \\chi' \\leq \\Delta+1$
