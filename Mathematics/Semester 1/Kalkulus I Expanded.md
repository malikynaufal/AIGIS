...
$$\lim_{x \to 0} \frac{\sin x}{x} = 1, \\quad \lim_{x \to 0} \frac{e^x - 1}{x} = 1$$#### 1.3 Continuity $f$is continuous at $a $if:
1.$f(a) $exists
...
#### 5.2 Volumes
**Disk**:$V = \pi\int_a^b [R(x)]^2\,dx$**Washer**:$V = \pi\int_a^b ([R(x)]^2 - [r(x)]^2)\,dx$**Shell**:$V = 2\pi\int_a^b x\cdot f(x)\,dx$#### 5.3 Wor
k
