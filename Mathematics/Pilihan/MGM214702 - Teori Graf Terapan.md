...
**Lemma jabat tangan (Handshaking Lemma):**$$\sum_{v \in V} \deg(v) = 2|E|$$**Korolari:** Jumlah simpul berderajat ganjil selalu genap.

**Teorema (Graf bipartit):**$G$adalah graf bipartit$\iff$ $G$tidak mengandung siklus ganjil.

**Teorema (Graf pohon):** Untuk graf$G$dengan$n$simpul:$$G \text{ adalah pohon} \iff G \text{ terhubung dan } |E| = n - 1 \iff G \text{ terhubung dan tanpa siklus} \iff G \text{ tidak ada siklus dan } |E| = n - 1$$### 1.4 Representasi Graf
...
**Max-Flow Min-Cut Theorem (Ford-Fulkerson, 1956):**$$\text{max flow}(s, t) = \text{min cut capacity}(s, t)$$*Algoritma Ford-Fulkerson:*
