...
I(f_j) = \frac{1}{T}\left|\sum_{t=1}^{T} Y_t e^{-i2\pi f_j t}\right|^2, \quad f_j = \frac{j}{T} $$Properti:$\mathbb{E}[I(f_j)] \approx S(f_j)$(asymptotically unbiased) tetapi $\text{Var}[I(f_j)] \approx S(f_j)^2$(**tidak konsisten!**).
