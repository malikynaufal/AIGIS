...
## Algorithm
1. Choose $[a,b]$such that$f(a) \cdot f(b) < 0$2. Compute midpoint$c = \frac{a+b}{2}$3. If$f(c) = 0$(or$|b-a| < \varepsilon$), stop
...
- **Required iterations:**$n \geq \log_2\left(\frac{b-a}{\varepsilon}\right)$## In Geodesy
