...
X = \sum_{i=1}^k Z_i^2 \sim \chi^2(k)$$## Properties
| Property | Value |
|----------|-------|
| Mean |$k$|
| Variance |$2k$|
...
## In Geodesy
1. **Least squares goodness-of-fit:**$\hat{\sigma}_0^2 \cdot (n-u) \sim \chi^2(n-u)$2. **Variance component estimation:** Test if$\hat{\sigma}_0^2$is statistically 1
