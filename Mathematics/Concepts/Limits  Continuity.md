...
$$### Example: Epsilon-Delta Proof that $\lim_{x \to 3} (2x+1) = 7 $Let $\varepsilon > 0 $be given. We need $\delta > 0 $such that $$0 < |x - 3| < \delta \implies |(2x+1) - 7| < \varepsilon $$ Observe:$|(2x+1)-7| = |2x-6| = 2|x-3| $.
...
$$**Catatan penting** (important note): L'Hôpital's Rule applies **only** to indeterminate forms $0/0 $or $\infty/\infty $— applying it to a determinate form (misalnya $0/1$) gives the wrong answer.
