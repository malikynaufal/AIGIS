...
$$ ### Second-Order Linear ODEs $$ ay'' + by' + cy = f(x)$$
...
$$ From the second, angular momentum$ h = r^2\dot{\theta} $is conserved. Substituting into the first gives the orbit equation $$ r(t) = \frac{a(1-e^2)}{1 + e\cos\theta}$$ where $ a $= semi-major axis,$e$ = eccentricity — an ellipse!
