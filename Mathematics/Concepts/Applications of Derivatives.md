...
$ $ f'(x) > 0 \implies f \text{ increasing (naik)}f'(x) < 0 \implies f \text{ decreasing (turun)}$$
...
$ $ x_0 = 0.5 \implies x_1 = 0.5 - \frac{\cos(0.5) - 0.5}{-\sin(0.5) - 1} \approx 0.7553x_2 \approx 0.7391, \quad x_3 \approx 0.7390851 $$
