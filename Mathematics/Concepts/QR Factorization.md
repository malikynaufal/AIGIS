...
where $Q$ = orthogonal ($Q^T Q = I$), $R$ = upper triangular.
...
## In Geodesy
The least squares problem $Ax \approx b$ can be solved via QR factorization:

$$Rx = Q^T b$$

This avoids squaring the condition number $\kappa(A^T A) = [\kappa(A)]^2$.
