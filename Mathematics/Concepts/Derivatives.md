...
This limit, if it exists, gives the slope of the tangent line at $(a, f(a))$.
...
**Proof**: Similar to product rule, write $\frac{u}{v} = u \cdot v^{-1}$ and apply product + chain rules.
...
**Example**: Find $\frac{dy}{dx}$ for $x^2 + y^2 = r^2$

1. Differentiate: $\frac{d}{dx}[x^2] + \frac{d}{dx}[y^2] = 0$
...
The top slides down at 1.5 ft/s.
...
### Problem 1
Find $\frac{dy}{dx}$ for $y = x^2 \sin x$

**Solution**: Use product rule
$$y' = (x^2)'\sin x + x^2(\sin x)' = 2x\sin x + x^2\cos x$$

### Problem 2
Find $\frac{dy}{dx}$ for $y = \frac{x^2 + 1}{x^2 - 1}$
...
$$f''(x) = 6x - 6$$
- At $x = 0$: $f''(0) = -6 < 0$ → local maximum, $f(0) = 2$
- At $x = 2$: $f''(2) = 6 > 0$ → local minimum, $f(2) = -2$

### Problem 4
Find $\frac{dy}{dx}$ of $e^{xy} + x^2 = y$ at $(1, 1)$

**Solution**: Differentiate implicitly
$$e^{xy}(y + x\frac{dy}{dx}) + 2x = \frac{dy}{dx}$$
At $(1,1)$: $e^1(1 + \frac{dy}{dx}) + 2 = \frac{dy}{dx}$
