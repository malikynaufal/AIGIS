...
(uv)' = \lim_{h \to 0} \frac{u(x+h)v(x+h) - u(x)v(x)}{h}= \lim_{h \to 0} \left[ \frac{u(x+h)-u(x)}{h}v(x+h) + u(x)\frac{v(x+h)-v(x)}{h} \right]= u'(x)v(x) + u(x)v'(x)$$### 2.3 Quotient Rule
...
Differentiate:$2x\frac{dx}{dt} + 2y\frac{dy}{dt} = 0 $At $x=6$:$y = \sqrt{100-36} = 8$
...
f(x) = f(a) + f'(a)(x-a) + \frac{f''(a)}{2!}(x-a)^2 + \cdots$$## 8. Practice Problems
