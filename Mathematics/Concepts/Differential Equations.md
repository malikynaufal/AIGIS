...
$$e^{2x}y = \int e^{2x}e^{-x}\,dx = \int e^{x}\,dx = e^{x} + Cy = e^{-x} + Ce^{-2x} $$### 2.3 Exact Equations
...
y(t) = -e^{-t} + 3e^{-2t} + te^{-t} $$## 6. Practice Problems

### Problem 1
Solve $\frac{dy}{dx} = \frac{x}{y} $, $y(0) = 3$**Solution**: Separable

$$\int y\,dy = \int x\,dx \implies \frac{y^2}{2} = \frac{x^2}{2} + Cy(0) = 3 \implies C = \frac{9}{2}y = \sqrt{x^2+9} $$### Problem 2
