...
The antiderivative (indefinite integral) of $f(x) $ is $ $\int f(x)\,dx = F(x) + C
...
$$**Example**: Evaluate $\int x\cos(x^2)\,dx $ Let $  u = x^2 $,$ du = 2x\,dx $, so $ x\,dx = \frac{du}{2} $

$ $\int x\cos(x^2)\,dx = \frac{1}{2}\int \cos u\,du = \frac{1}{2}\sin(x^2) +
C

$$

# ## 4.2 Integration by Parts $ $\int u\,dv = uv - \int v\,du
...
Solving: $ 2x+3 = A(x-1) + B(x+2) $-$  x = -2 $: $ 1 = A(-3) $→$  A = -\frac{1}{3} $-$  x = 1 $: $ 5 = 3B $→$  B = \frac{5}{3} $
...
**Disk Method**: $ V = \pi \int_a^b [R(x)]^2\,dx $**Washer Method**: $  V = \pi \int_a^b ([R(x)]^2 - [r(x)]^2)\,dx $**Shell Method**: $  V = 2\pi \int_a^b x \cdot f(x)\,dx $### 6.3 Arc Lengt
h

$ $  L = \int_a^b \sqrt{1 + [f'(x)]^2}\,dx $$

# ## 6.4 Surface Area of Revolutio
n
