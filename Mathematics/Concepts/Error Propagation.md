...
$$\mathbf{Q}_{xx} = (\mathbf{H}^T\mathbf{H})^{-1} $$ Position standard deviations $$\sigma_X = \sigma_\rho\sqrt{q_{XX}}, \quad \sigma_Y = \sigma_\rho\sqrt{q_{YY}}, \quad \sigma_Z = \sigma_\rho\sqrt{q_{ZZ}} $$
