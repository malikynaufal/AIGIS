...
If $(X, d)$ is complete and $T: X \to X$ is a **contraction** ($d(Tx, Ty) \leq q \cdot d(x,y)$, $q < 1$), then $T$ has a unique fixed point $x^*$ and:

$$d(x_n, x^*) \leq \frac{q}{1-q} d(x_0, Tx_0)$$
