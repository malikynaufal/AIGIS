...
#### 3.1 Inner Product$$\\langle u, v \\rangle
$$
...
$$
w_k = v_k - \\sum_{i=1}^{k-1} \\langle v_k,u_i\\rangle u_i, \\quad u_k = \\frac{w_k}{\\|w_k\\|}$$#### 3.5 Orthogonal Complement$W^\\perp = \\{v: \\langle v,w\\rangle = 0 \\, \\forall w \\in W\\}$
