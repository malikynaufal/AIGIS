...
$$\sum_{n=1}^{\infty} a_n = \lim_{N\to\infty} S_N, \\quad S_N = \sum_{n=1}^N a_n$$**Nth term test**: If $\lim a_n \neq 0$, the series diverges.
...
\sum_{n=1}^{\infty} \frac{1}{n^p} \begin{cases} \text{converges} & p>1 \\ \text{diverges} & p\leq 1 \end{cases} $$#### 3.6 Comparison Tests
...
\rho = \lim_{n\to\infty} \frac{a_{n+1}}{a_n} $$-$\rho < 1$: converges
...
$$f(x) = T_n(x) + R_n(x)$$where $T_n $is the $n $th degree Taylor polynomial and:
