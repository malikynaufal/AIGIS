...
$$A_1 v_1 = A_2 v_2$$
where $A$ is cross‑sectional area, $v$ velocity.
...
2. Bernoulli: $p_2 = p_1 + rac{1}{2}\rho (v_1^2 - v_2^2)$
   $$p_2 = 200\,	ext{kPa} + 0.5	imes1.225(5^2 - 12.5^2)pprox 200 - 94.9\,	ext{kPa} = 105.1\,	ext{kPa}$$

**Dimensional check:** $[p] = 	ext{N/m}^2 = 	ext{kg/(m·s}^2)$ ✓
...
Relates shear stress $\tau$ to velocity gradient:
$$\tau = \mu \frac{du}{dy}$$
...
$$v_{	ext{avg}} = rac{Q}{\pi R^2} = \frac{R^2}{8\mu}\frac{\Delta p}{L}$$
