...
For incompressible flow ($\rho =$const)
:

$$A_1 v_1 = A_2 v_2$$where $A$is cross‑sectional area,$v $velocity.
...
$$Q = \frac{\pi R^4}{8\mu}\frac{\Delta p}{L}v_{	ext{avg}} = rac{Q}{\pi R^2} = \frac{R^2}{8\mu}\frac{\Delta p}{L} $$### Example: Blood Flow in an Artery
