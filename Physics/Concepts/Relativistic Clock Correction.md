...
$$A moving clock ticks slower (dilated):$$

\frac{\Delta\tau}{\Delta t} = \sqrt{1 - \frac{v^2}{c^2}} \approx 1 - \frac{v^2}{2c^2} $$### GPS Satellite Velocity
...
$$d\tau^2 = \left(1 - \frac{2GM}{rc^2}\right)dt^2 - \frac{1}{c^2}\left(1 - \frac{2GM}{rc^2}\right)^{-1}dr^2 - \frac{r^2}{c^2}d\Omega^2$$For a clock at radius $r$, at rest ($dr = d\Omega = 0$):
...
\Delta\tau_{GR} = 5.5208\times 10^{-10}\times 86400 = +47.7 \text{ μs/day} $$**Interpretation:** Satellite clocks gain 47.7 μs/day (run faster) because they sit higher in Earth's gravitational potential well — spacetime is "flatter" there.
...
$$\Delta t_{\text{rel}} = -\frac{2\sqrt{GM\cdot a}}{c^2}e\sin E$$where $E$= eccentric anomaly from Kepler's equation,$a$= semi-major axis,$e$ = eccentricity.
