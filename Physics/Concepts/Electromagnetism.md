...
$$ \mathcal{E} = -L\frac{dI}{dt} $$ For a solenoid: $$ L = \mu_0 n^2 \ell A $where $\ell$ is length,$A$ is cross-sectional area.
...
**### Plane Wave Solutions **
 ...
 \vec{E} = \vec{E}_0\cos(\vec{k}\cdot\vec{r} - \omega t)\vec{B} = \vec{B}_0\cos(\vec{k}\cdot\vec{r} - \omega t)
