...
$ $ \sigma_x \sigma_p \geq rac{\hbar}{2}\sigma_E \sigma_t \geq rac{\hbar}{2} $$
...
$ E_n = -rac{me^4}{8\epsilon_0^2 h^2}rac{1}{n^2} = -rac{13.6\,	ext{eV}}{n^2} **### Radial Wave Functions **
...
$ $ \hat{\mathbf{L}} = \hat{\mathbf{r}} 	imes \hat{\mathbf{p}}\hat{L}^2 = \hbar^2 l(l+1)\hat{L}_z = \hbar m
