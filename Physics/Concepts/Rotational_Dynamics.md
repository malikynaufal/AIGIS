...
**Given:** Earth's oblateness $f = 1/298.257$, lunisolar torque $\\tau$

**Find:** Precession rate $\\psi$

**Solution:**
1. **Identify principle:** Euler equation for forced precession of oblate body
2. **Set up:** $\\tau = (I_3 - I_1)\\Omega\\psi$
3. **Solve:** $\\psi = \\frac{\\tau}{(I_3 - I_1)\\Omega} \\approx 50.3''$/yr
