...
x(t) = v_0\cos\theta \cdot ty(t) = v_0\sin\theta \cdot t - \frac{1}{2}gt^2$$**Range** (level ground):$R = \frac{v_0^2 \sin 2\theta}{g} $**Maximum height**:$H = \frac{v_0^2 \sin^2\theta}{2g} $### Relative Velocit
y
...
A force directed along the line joining two particles.
...
$$E = -\frac{mk^2}{2L^2} \cdot p = -\frac{k}{2a} $$

**Period** (Kepler's Third Law)
:

$$T^2 = \frac{4\pi^2 a^3}{GM} $$where $a$= semi-major axis.
