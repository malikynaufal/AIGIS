...
**### Solution **
 ...
 x(t) = A\cos(\omega_0 t + \phi) $ where $\omega_0 = \sqrt{k/m} $ (natural angular frequency).$
...
$$ \omega_{\text{res}} = \sqrt{\omega_0^2 - 2\gamma^2} \quad \text{(amplitude resonance)} $$ For small damping ($\gamma \ll \omega_0$): $ \omega_{\text{res}} \approx \omega_0 $Maximum amplitude at resonance $A_{\text{max}} = \frac{F_0}{2\gamma m\omega_0} = \frac{Q \cdot F_0}{m\omega_0^2} $$$
...
$m_1\ddot{x}_1 = -k_1 x_1 - k_{12}(x_1 - x_2)m_2\ddot{x}_2 = -k_2 x_2 + k_{12}(x_1 - x_2) $$$

### Normal Modes
Solutions are superpositions of normal modes

$x_i(t) = A_i e^{i\omega_\alpha t + \phi_\alpha}$For $m_1 = m_2 = m $ and $k_1 = k_2 = k$:
