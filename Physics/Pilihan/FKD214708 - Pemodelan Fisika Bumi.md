...
$$ \frac{dT}{dz} \approx 25\text{–}30 \;\text{°C/km} $$ For Indonesia's volcanic regions (e.g., Sarulla, Lahendong geothermal fields), gradients reach 50–100 °C/km near heat sources.
...
**Bouguer anomaly** (anomali Bouguer) $$ \Delta g_B = g_{\text{obs}} - g_{\text{theoretical}} + \delta g_{\text{terrain}} - 2\pi G \rho h
