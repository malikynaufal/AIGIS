# Physics Resources
## Curated Open-Access Bibliography for Geodesy Physics
...
- **Curriculum Guide:** [[Physics_Curriculum_Guide]] — semester-aligned with UGM
- **Study Plan:** [[Study Plan]] — weekly rhythm and milestones

## 🔗 Subject Links
- [[Geodesy MOC]] — uses: gravity field, GNSS signals, reference frames
- [[Mathematics MOC]] — uses: vector calculus, differential equations, tensors
...
| `Concepts/` | Concept notes (Newton's laws, gravity, relativity, etc.) |
