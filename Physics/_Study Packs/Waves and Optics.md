...
$$ \frac{\partial^2 y}{\partial x^2} = \frac{1}{v^2}\frac{\partial^2 y}{\partial t^2} $$ General solution: $$ y(x,t) = f(x-vt) + g(x+vt) $### Harmonic Wav
e
...
$$ I(\theta) = I_0 \left(\frac{\sin\beta}{\beta}\right)^2, \quad \beta = \frac{\pi a\sin\theta}{\lambda} $$ Minima: $$ a\sin\theta = m\lambda \quad (m \neq 0) $### Circular Aperture (Airy Pattern
)

$$ I(\theta) = I_0 \left(\frac{2J_1(\pi D\sin\theta/\lambda)}{\pi D\sin\theta/\lambda}\right)^2 $$ First minimum:$ \theta_{\min} \approx 1.22\lambda/D$**Rayleigh criterion:**$ \theta_{\min} = 1.22\lambda/D$---
...
$$ \frac{dN_2}{dt} = R_p - \frac{N_2}{\tau_2} - W(N_2 - N_1)\frac{d\phi}{dt} = W(N_2 - N_1)\phi - \frac{\phi}{\tau_c} $$ where $\phi$ = photon density,$ \tau_c$= cavity lifetime.
