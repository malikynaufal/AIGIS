...
$$ u^\mu = \frac{dx^\mu}{d\tau} = \gamma(c, \vec{v}) $$ Normalization: $$ u^\mu u_\mu = -c^2$### Four-Acceleratio$
n

$$ a^\mu = \frac{du^\mu}{d\tau} $$ Property: $$ u^\mu a_\mu = 0$ (orthogonal to four-velocity)$
