...
1
$$Iterate:$ $\sin\sigma = \sqrt{(\cos U_2\sin\lambda)^2 + (\cos U_1\sin U_2 - \sin U_1\cos U_2\cos\lambda)^2}\cos\sigma = \sin U_1\sin U_2 + \cos U_1\cos U_2\cos\lambda\sigma = \arctan(\sin\sigma/\cos\sigma)
