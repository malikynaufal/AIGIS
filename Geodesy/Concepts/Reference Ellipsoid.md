...
Iterate:$ $ N_i = \frac{a}{\sqrt{1-e^2\sin^2\phi_i}}\phi_{i+1} = \arctan\left(\frac{Z + e^2 N_i \sin\phi_i}{p}\right)$$
...
where:$ $ p = \sqrt{X^2+Y^2}, \quad \nu = \frac{a^2}{\sqrt{a^2\cos^2\phi + b^2\sin^2\phi}}\phi = \arctan\left(\frac{Z + e'^2 b\sin^3\theta}{p - e^2 a\cos^3\theta}\right)$$
