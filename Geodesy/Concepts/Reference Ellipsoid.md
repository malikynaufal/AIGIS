...
$$ b = a(1-f) = \frac{a}{\sqrt{1+e'^2}}a = b\sqrt{1+e'^2} = \frac{b}{\sqrt{1-e^2}}e^2 = 2f - f^2 = \frac{a^2-b^2}{a^2}e'^2 = \frac{f(2-f)}{(1-f)^2} = \frac{a^2-b^2}{b^2}f = 1 - \frac{b}{a} = 1 - \sqrt{1-e^2}$$
...
$$ Iterate:$$ N_i = \frac{a}{\sqrt{1-e^2\sin^2\phi_i}}\phi_{i+1} = \arctan\left(\frac{Z + e^2 N_i \sin\phi_i}{p}\right)$$ Converge when$ |\phi_{i+1} - \phi_i| < \epsilon$:
...
$$ where:$$ A = 1 - \frac{e^2}{4} - \frac{3e^4}{64} - \frac{5e^6}{256}B = \frac{3e^2}{8} + \frac{3e^4}{32} + \frac{45e^6}{1024}C = \frac{15e^4}{256} + \frac{45e^6}{1024}D = \frac{35e^6}{3072}$$
