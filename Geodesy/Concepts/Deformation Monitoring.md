...
\mathbf{r}(t) = \mathbf{r}_0 + \mathbf{v} \cdot t + \mathbf{A}_1 \sin(2\pi t) + \mathbf{A}_2 \cos(2\pi t)

$$

### Reference Frame for Deformation

$$

\Delta \mathbf{r} = \mathbf{r}_{target}(t) - \mathbf{r}_{ref}(t) - \mathbf{T}_{plate}(t)
...
\hat{v} \pm t_{\alpha/2, n-2} \cdot \frac{s_v}{\sqrt{n}}
