...
$$ Converges in 3–5 iterations to double-precision accuracy. Then:$$ h = \frac{p}{\cos\phi} - N $$

### Bowring's Algorithm (Non-Iterative)

A fast single-step method with ~μm accuracy:

$$\tau = \frac{Z}{p}\frac{a}{b}\phi = \arctan\left(\frac{Z + b\,e'^2\sin^3\theta}{p - a\,e^2\cos^3\theta}\right), \quad \theta = \arctan(\tau)
