...
The **second eccentricity** $ e'$is used in some geodetic formulas (particularly for auxiliary latitudes and the [[Transverse Mercator]] projection)$$ e' = \sqrt{\frac{a^2}{b^2} - 1}$$ It is related to the first eccentricity by $$ e' = \frac{e}{\sqrt{1 - e^2}}$$
...
$$ e^2 = 2f - f^2f = 1 - \sqrt{1 - e^2}$$ This relationship means an ellipsoid can be defined equivalently by $ (a, f) $or $ (a, e) $. For small flattening ($f \approx 0.00335 $for Earth), a useful approximation is
