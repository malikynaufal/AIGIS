...
### Spherical Harmonic Expansion of the Gravitational Potential$$V(r,\theta,\lambda) = \frac{GM}{r}\sum_{n=0}^{\infty}\sum_{m=0}^{n} \left(\frac{a}{r}\right)^n \left[\bar{C}_{nm}\cos m\lambda + \bar{S}_{nm}\sin m\lambda\right] \bar{P}_{nm}(\cos\theta)$$| Term | Meaning | Value for Earth |
|------|---------|-----------------|
...
**International Gravity Formula 1980** (GRS80):$$g_{rs}(\phi) = 9.780327 \left[ 1 + 0.0053024 \sin^2\phi - 0.0000058 \sin^2 2\phi \right] \quad \text{m/s}^2$$**WGS84 (EGM96):**$$g_{wgs}(\phi) = 9.7803253359 \cdot \frac{1 + 0.00193185265241\sin^2\phi}{\sqrt{1 - 0.00669437999014\sin^2\phi}} \quad \text{m/s}^2$$---
...
### Bruns' Formula$$N = \frac{W(P) - U(Q_0)}{\gamma(Q_0)} = \frac{T(P)}{\gamma(Q_0)}$$This elegantly links the geoid undulation$N$to the disturbing potential$T$.
