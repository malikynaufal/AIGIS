...
### Temperature Correction$ $\Delta s_T = s \cdot \alpha_T \cdot (T - T_0)$\$$where $ \alpha_T \approx 0.00003 $ /°C for K-band instruments.

### Pressure Correction$ $\Delta s_P = s \cdot \alpha_P \cdot (P - P_0)$\$$where $ \alpha_P \approx 0.00027 $ /hPa for K-band.
