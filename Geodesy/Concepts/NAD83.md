...
At epoch $t$:$ $\mathbf{X}_{ITRF2008}(t) = \mathbf{T}(t) + (1+s)\,\mathbf{R}(t)\,\mathbf{X}_{NAD83}(t)$\$$| Parameter |$T_x$|$T_y$|$T_z$|$s$|$R_x$|$R_y$|$R_z$ |
|-----------|-------|-------|-------|-----|-------|-------|-------|
...
For quick checks only (±10 m accuracy):$ $ T_x \approx −6\ \text{m}, T_y \approx 158\ \text{m}, T_z \approx −176\ \text{m}$$# # Usage and EPSG Codes
