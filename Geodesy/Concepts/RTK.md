...
### 3.3. Validation – Ratio test$$\text{Ratio} = \frac{\text{Second‑best quadratic form}}{\text{Best quadratic form}}$$If$\text{Ratio} > \text{threshold}$(typically 3 or 4), the fix is accepted.
