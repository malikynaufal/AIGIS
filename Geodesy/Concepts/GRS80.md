...
## Derivation of $e^2$ Starting from $f$:$ $ e^2 = 2f - f^2 = 2 \times \frac{1}{298.257222101} - \left(\frac{1}{298.257222101}\right)^2 $$$ $= 6.705\,516\,586 \times 10^{-3} - 1.126\,412\,239 \times 10^{-5}
$$
...
The $1/f$ difference produces a maximum surface separation of:$ $\Delta h_{max} = a \cdot \Delta f \approx 6.378 \times 10^6 \times 1.6 \times 10^{-11} \approx 0.1 \text{ mm}
$$
**Conclusion:** The two ellipsoids are geometrically indistinguishable for all surveying purposes.

## Radius of Curvature (on GRS80)

### Meridian Radius$ $ M(\varphi) = \frac{a(1 - e^2)}{(1 - e^2 \sin^2\varphi)^{3/2}}$ $### Prime Vertical Radius$ $ N(\varphi) = \frac{a}{(1 - e^2 \sin^2\varphi)^{1/2}}$ $### Gaussian Curvature Radius$ $ K(\varphi) = \frac{MN}{a^2} = \frac{a}{(1 - e^2\sin^2\varphi)}$$# # Values at Key Latitudes
...
**Meridian:**$ $\Delta s_M \approx M(\varphi) \times \frac{\pi}{180}
...
1. **Gravity formula:** International Gravity Formula (IGF 1980)$ $\gamma_0(\varphi) = 9.780327(1 + 0.0053024\sin^2\varphi - 0.0000058\sin^2 2\varphi) \text{ m/s}^2
