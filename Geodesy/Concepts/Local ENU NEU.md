...
**Step 1:** Compute the ECEF displacement vector from the origin$ $\Delta\mathbf{X} = \mathbf{X}_P - \mathbf{X}_0
$$**Step 2:** Apply the rotation matrix$$
\begin{pmatrix} E \\ N \\ U \end{pmatrix} = \mathbf{R}(\phi_0, \lambda_0) \cdot \Delta\mathbf{X} $$where:$ $\mathbf{R}(\phi_0, \lambda_0) = \begin{pmatrix}
...
F
$$
\begin{pmatrix} dX \\ dY \\ dZ \end{pmatrix} = \mathbf{R}^T(\phi_0, \lambda_0) \cdot \begin{pmatrix} E \\ N \\ U \end{pmatrix} $$Since rotation matrices are orthogonal:$\mathbf{R}^{-1} = \mathbf{R}^T $.
...
2. Compute the displacement:$ $\Delta X = -1265806.4 - (-1265973.8) = 167.4\ \text{m}\Delta Y = -4725078.0 - (-4725276.4) = 198.4\ \text{m}\Delta Z = 4076657.6 - 4076485.7 = 171.9\ \text{m} $$3. Apply rotation:
