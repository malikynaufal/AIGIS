...
$$\Delta g_{\text{FA}} = g_{\text{obs}} + g_{\text{Fay}} - \gamma
...
$$ h = H + N $$ This equation is one of the most important in physical geodesy, allowing conversion between GNSS-derived ellipsoidal heights and traditional levelling-derived orthometric heights.
