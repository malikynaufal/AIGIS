...
h = \frac{p}{\cos\phi} - N$$### Bowring's Iterative Method (1976)

A single-iteration approximation with sub-millimeter accuracy for most ellipsoids
:

$$\phi = \arctan\left(\frac{Z + b\,\varepsilon^2 \sin^3\theta}{p - a\,e^2 \cos^3\theta}\right)$$where $\theta = \arctan\left(\frac{a}{b} \cdot \frac{Z}{p}\right)$,$\varepsilon^2 = \frac{a^2 - b^2}{b^2} $, and the $e'^2 = \frac{a^2 - b^2}{b^2} $.
...
X = (6391250 + 100) \times \cos(51.477^\circ) \times \cos(-0.001^\circ)= 6391350 \times 0.62315 \times 0.999999985 = 3,982,718\ \text{m}Y = 6391350 \times 0.62315 \times \sin(-0.001^\circ) = 6391350 \times 0.62315 \times (-0.0000175) = -69.1\ \text{m}Z = (6391250 \times 0.993306 + 100) \times 0.78246 = (6348522 + 100) \times 0.78246 = 4,966,175\ \text{m} $$**Result:**$(X, Y, Z) \approx (3,982,718, -69.1, 4,966,175) $m
...
$$3.$e'^2 = \frac{a^2 - b^2}{b^2} = 0.0067395$4. Single iteration
:

$$\phi = \arctan\left(\frac{Z + b \cdot e'^2 \cdot \sin^3\theta}{p - a \cdot e^2 \cdot \cos^3\theta}\right)= \arctan\left(\frac{4966175 + 6356752 \times 0.0067395 \times 0.1287}{3982718 - 6378137 \times 0.0066944 \times 0.648}\right)$$

Numerator $\approx 4966175 + 5480 = 4971655 $Denominator $\approx 3982718 - 28110 = 3954608$

$$\phi = \arctan(4971655 / 3954608) = \arctan(1.2571) = 51.477^\circ$$5.$h$: With $\phi \approx 51.477^\circ$,$N = 6391250$
m
