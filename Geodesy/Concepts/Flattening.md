...
The second flattening $ f'$(also called the *second ellipticity*) is $$ f' = \frac{a - b}{b}$$ It relates to the first flattening by $$ f' = \frac{f}{1 - f}$$

## Third Flattening (n) — Third Eccentricity Squared

The third flattening $n$(used in series expansions for geodesics) is

$$ n = \frac{a - b}{a + b} = \frac{f}{2 - f}$$ For WGS84:$ n \approx 0.001679220394 $
