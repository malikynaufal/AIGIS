...
**Inverse:**
$$\lambda = \frac{x}{R}$$
$$\phi = 2\arctan(e^{y/R}) - \frac{\pi}{2}$$

**Scale factor:**
$$m = \frac{1}{\cos\phi} = \sec\phi$$

**Distortion:** Scale increases toward poles (infinite at poles). Used for navigation (straight lines are loxodromes).
...
**Scale factor (central meridian):** $k_0 = 0.9996$
