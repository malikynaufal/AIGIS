...
The angle between the grid north ( $Y$-axis) and true (geodetic) north is the **grid convergence** $\gamma$:$ $\gamma \approx l \cdot \sin\phi$$
...
**Solution:**$ $\gamma = l \cdot \sin\phi = 1.5^\circ \times \sin(45^\circ) = 1.5^\circ \times 0.7071 = 1.06^\circ = 1^\circ 3' 36''$$**Interpretation:** The UTM grid lines at this point are rotated 1° 4′ east of true north. Surveyors must apply this convergence when converting compass bearings to grid azimuths.
