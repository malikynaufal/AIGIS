...
**Complex quantity:**
$$\zeta + i\,\eta = \omega_0 + k_0 \cdot (q + i\,\eta_q)$$
...
where $\tilde{M}$ is the **meridian arc length** from equator to latitude $\phi$:

$$\tilde{M} = a\int_0^\phi \frac{(1-e^2)\,d\phi}{(1-e^2\sin^2\phi)^{3/2}}$$

The full series expansion includes terms up to $l^6$.

## Scale Factor

The **TM scale factor** $k$ at any point $(\phi, \lambda)$ is:

$$k = k_0 \left(1 + \frac{l^2}{2}\cos^2\phi(1 + \frac{e^2}{1-e^2}\sin^2\phi + c + \frac{l^2}{12}\cos^2\phi \cdots) \right)$$
...
This is the fundamental geometric relationship of TM projections: grid lines and meridians converge as you move away from the central meridian.
...
**Solution:**
$$\gamma = l \cdot \sin\phi = 1.5^\circ \times \sin(45^\circ) = 1.5^\circ \times 0.7071 = 1.06^\circ = 1^\circ 3' 36''$$
