...
For ionosphere-free combination:$ $\Phi_{LC} = \frac{f_1^2 \Phi_1 - f_2^2 \Phi_2}{f_1^2 - f_2^2} = \rho + c(\delta t_u - \delta t^s) + T + \lambda_{LC} N_{LC}
$$
# # LAMBDA Method
...
The most common validation is the ratio test:$ $R = \frac{\Delta\chi^2_2}{\Delta\chi^2_1} = \frac{\|\hat{\mathbf{a}} - \mathbf{a}_2\|^2_{Q^{-1}}}{\|\hat{\mathbf{a}} - \mathbf{a}_1\|^2_{Q^{-1}}} $$| Ratio Value | Confidence | Decision |
|-------------|------------|----------|
| > 5 | Very high | Fix |
...
### Wide-Lane Combination$ $ \lambda_{WL} = \frac{c}{f_1 - f_2} = \frac{c}{10.23 \text{ MHz}} \approx 86.19 \text{ cm}
$$
$ $\Phi_{WL} = \Phi_1 - \Phi_2, \quad N_{WL} = N_1 - N_2
$$# ## Narrow-Lane Combination$ $\lambda_{NL} = \frac{c}{f_1 + f_2} \approx 10.70 \text{ cm}
$$
$ $N_{NL} = N_1 + N_2$$# # In [[Geodesy]] Context
