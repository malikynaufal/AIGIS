...
$$\sin\alpha_1 = \frac{\sin u_1}{\cos u_1} \cdot \frac{1}{A}\sin\alpha = \cos u_1 \sin\alpha_1$$Then compute the destination using the inverse formulas with $\sigma$ as input.
