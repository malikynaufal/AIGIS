...
The tidal potential from a body of mass $m $at distance $r $is expanded in spherical harmonics. The dominant term is the **second‑degree** component (the first degree is a pure translation and does not deform)
:

$$V_{\text{tide}}(r,\theta,\lambda,t) = \sum_{n=2}^{3} \sum_{m=0}^{n} V_{nm}(\theta,\lambda,t)\left(\frac{r_0}{r}\right)^{n+1} $$
