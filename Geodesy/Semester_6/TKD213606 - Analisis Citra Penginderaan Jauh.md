...
- Hukum Planck dan radiasi benda hitam: $B_\lambda = \frac{2hc^2}{\lambda^5}\frac{1}{e^{hc/\lambda k_BT}-1}$
- Konsep spektrum reflektan: $\rho_\lambda = \frac{L_\lambda}{E_\lambda}$ untuk material tanah, air, dan vegetasi
...
- **Image differencing**: $\Delta DN = DN_{t_2} - DN_{t_1}$
- **Change Vector Analysis (CVA)**: deteksi perubahan multivariate
