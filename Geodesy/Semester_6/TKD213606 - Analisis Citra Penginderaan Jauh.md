...
NDVI = \frac{NIR - RED}{NIR + RED}$$- NDWI (Normalized Difference Water Index) untuk deteksi air:$$NDWI = \frac{GREEN - NIR}{GREEN + NIR}$$- EVI (Enhanced Vegetasi Index) untuk vegetasi padat:$$EVI = 2.5 \times \frac{NIR - RED}{NIR + 6 \times RED - 7.5 \times BLUE + 1}
$$
