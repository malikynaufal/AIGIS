...
The **slowing factor** for GPS satellites $$\frac{v^2}{2c^2} = \frac{(3874)^2}{2(299{,}792{,}458)^2} \approx -8.34 \times 10^{-11} $ $
...
The **ionospheric range delay** (group delay for pseudorange)$$ \Delta \rho_{\text{iono}} = +\frac{40.3}{f^2} \int_{\text{path}} N_e \, ds = \frac{40.3 \cdot \text{STEC}}{f^2} $ $
...
The covariance matrix of the estimated parameters $$ Q_{xx} = (A^T P A)^{-1} $ $
