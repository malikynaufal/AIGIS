...
Parallax stereoskopik:$ $B = Z_1 - Z_2 \quadext{(base)}p = x_1 - x_2 \quadext{(x-parallax)
}$ $Perhitungan tinggi dari parallax:$ $\Delta h = \frac{H \cdot \Delta p}{B + \Delta p}$ $ 4. Orthorektifikasi

Mengoreksi distorsi geometrik pada foto akibat relief:$ $## 4. Orthorektifikasi

Mengoreksi distorsi geometrik pada foto akibat relief:X = X_0 + (Z-Z_0)\frac{a_1x + a_2y - a_3f}{c_1x + c_2y - c_3f}$$# ## 4. Orthorektifikasi
