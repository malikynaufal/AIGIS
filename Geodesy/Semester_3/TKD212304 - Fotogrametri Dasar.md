...
$$
y = -f\frac{a_2(X-X_0)+b_2(Y-Y_0)+c_2(Z-Z_0)}{a_3(X-X_0)+b_3(Y-Y_0)+c_3(Z-Z_0)}$$-$f$= focal length
...
$$
p = x_1 - x_2 \quad\text{(x-parallax)}$$Perhitungan tinggi dari parallax:$$\Delta h = \frac{H \cdot \Delta p}{B + \Delta p}$$### 4. Orthorektifikasi
