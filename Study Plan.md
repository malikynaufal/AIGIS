# Physics Study Plan
## UGM Geodesy Physics Progression

**Purpose:** Structured learning path for physics as applied to geodesy  
**Duration:** 5 semesters (Semester 1–5 of UGM Geodesy program)

---

## 📅 Semester 1 — Classical Mechanics & Thermodynamics (3 SKS)
...
## 📅 Semester 2 — Geophysics & Astronomy (2 SKS)
...
## 📅 Semester 4 — Satellite Geodesy Physics (2 SKS)

### Primary Goals:
- [ ] Master EM wave propagation for GNSS signals
- [ ] Understand ionospheric and tropospheric delay physics
- [ ] Learn satellite orbital mechanics
- [ ] Apply relativistic corrections

### Weekly Rhythm:
| Day | Focus | Duration |
|-----|-------|----------|
| Mon | EM waves + GNSS frequencies | 2 hrs |
| Tue | Ionospheric/tropospheric models | 2 hrs |
| Wed | Orbital mechanics + Kepler | 2 hrs |
| Thu | Relativistic corrections | 2 hrs |
| Fri | Signal processing + positioning | 1.5 hrs |
...
- [ ] **Week 12:** Compute satellite position from Keplerian elements
- [ ] **Week 16:** Calculate relativistic clock correction (38 μs/day)

### Geodesy Connections:
- This course IS the physics of modern positioning
- All GNSS surveying depends on understanding signal physics
- Relativistic effects → mm-level accuracy requirement

### Resources:
- Hofmann-Wellenhof et al., "GNSS"
- IS-GPS-200 Interface Spec
- RTKLIB tutorials
- IGS analysis center documents

---

## 📅 Semester 5 — Physical Geodesy (2 SKS)
...
| Sunday | Integration + review | 1 hr |
...
| μs/day | 38 μs/day | Relativistic clock offset (GPS) |
...
### Online Resources:
- MIT OCW 8.01, 8.02 (Classical Mech, E&M)
